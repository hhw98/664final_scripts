...
DROP TABLE IF EXISTS color, director, movie_language, country, content_rating, plot_keyword, genre, movie, movie_genres, movie_keywords;
...
LOAD DATA LOCAL INFILE 'D:/664/project/output/combine.csv'
INTO TABLE `movies`.`temp_movie`
    FIELDS TERMINATED BY ',' 
    ENCLOSED BY '"' 
    LINES TERMINATED BY '\n'
  IGNORE 1 LINES
  (color_name, director_name, duration, movie_title, movie_imdb_link,  language_name, country_name, content_rating,  title_year, genre, keyword, imdb_score)
